...
async def play(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/fb45a1e4a5315c24e776c.png",
        caption=f"**Playing Your song Via Marshmallo Music Bot.**",
         ) 
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        await res.edit(
            "**Found Literally Nothing ! You Should Work On Your English dumbo😝**"
        )
        is_playing = False
        return
